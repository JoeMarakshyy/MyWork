define('app',['exports', 'aurelia-framework', 'aurelia-auth'], function (exports, _aureliaFramework, _aureliaAuth) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaAuth.FetchConfig), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.title = 'ToDo';
      config.map([{ route: ['', 'home'], moduleId: './modules/home', name: 'Home' }, { route: 'list', moduleId: './modules/list', name: 'List', auth: true }, { route: 'form', moduleId: './modules/form', name: 'Form', auth: true }]);
    };
...
define('resources/data/todos',['exports', 'aurelia-framework', './data-services'], function (exports, _aureliaFramework, _dataServices) {
	...
	var Todos = exports.Todos = (_dec = (0, _aureliaFramework.inject)(_dataServices.DataServices), _dec(_class = function () {
		...
		Todos.prototype.uploadFile = function uploadFile(files, user, todo) {
